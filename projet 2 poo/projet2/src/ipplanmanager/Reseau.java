...
public class Reseau implements Affichable {
    ...
    // ─── Attributs ───────────────────────────────────────────────
    private String nom;
    private double bandeFréquenceUplink;   // MHz
    private double bandeFréquenceDownlink; // MHz
    ...
    public Reseau(String nom, double bandeFréquenceUplink, double bandeFréquenceDownlink,
        ...
        this.nom                    = nom;
        this.bandeFréquenceUplink   = bandeFréquenceUplink;
        this.bandeFréquenceDownlink = bandeFréquenceDownlink;
    ...
    public void afficherPerformances() {
        ...
        System.out.println("Débit max Uplink   : " + debitMaxUplink + " Mbps");
        System.out.println("Débit max Downlink : " + debitMaxDownlink + " Mbps");
        System.out.println("Délai max          : " + maxDelai + " ms");
        System.out.println("Nombre de BTS      : " + nbBTS);
        System.out.println("Total abonnés      : " + calculerNbAbonnes());
        int satureCount = 0;
        for (int i = 0; i < nbBTS; i++) {
    ...
    public void afficherInfos() {
        ...
        System.out.println("╠══════════════════════════════════════╣");
        System.out.println("  Fréquence Uplink   : " + bandeFréquenceUplink + " MHz");
        System.out.println("  Fréquence Downlink : " + bandeFréquenceDownlink + " MHz");
        System.out.println("  Type d'accès       : " + typeAcces);
    ...
    public String toString() {
        return "Réseau[" + nom + "] | BTS: " + nbBTS + " | Abonnés: " + calculerNbAbonnes();
    }
